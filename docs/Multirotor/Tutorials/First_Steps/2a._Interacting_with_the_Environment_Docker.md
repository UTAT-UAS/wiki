---
title: Interacting with the Environment (Docker)
---
...
> If you are using a VM, you don't need X11 for GUI forwarding, check the next page of the tutorial to setup a network to forward traffic between your VM and host.
...
[Interacting with the Environment (VM)](./2b._Interacting_with_the_Environment_VM.md)
